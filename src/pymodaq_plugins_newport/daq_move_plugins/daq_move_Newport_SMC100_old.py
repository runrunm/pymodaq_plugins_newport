...
from pymodaq_plugins_newport.hardware.smc100_old import SMC100
import pyvisa

VISA_rm = pyvisa.ResourceManager()
infos = VISA_rm.list_resources_info()
com_ports = [infos[key].interface_board_number for key in infos.keys()]
# print(infos)
VISA_rm.close()
...
class DAQ_Move_Newport_SMC100(DAQ_Move_base):
    ...
    _epsilon = 0.0001
    params = [{'title': 'COM Port:', 'name': 'com_port', 'type': 'list', 'limits': com_ports, 'value': 'COM4'},
